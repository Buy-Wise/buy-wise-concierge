...
const databaseUrl = 'postgresql://neondb_owner:npg_6aZunfH3mLYl@ep-cold-shadow-a1g8l091-pooler.ap-southeast-1.aws.neon.tech/neondb?sslmode=require';
...
async function runMigration() {
  console.log('🚀 Starting direct schema synchronization...');
