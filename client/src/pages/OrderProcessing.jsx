  ...
  return (
    <div className="min-h-[calc(100vh-64px)] flex flex-col items-center justify-center p-4">
      <div className="max-w-md w-full bg-zinc-900 border border-zinc-800 rounded-2xl p-10 text-center shadow-2xl">
        <h2 className="text-3xl font-bold mb-4 text-[#D4AF37]">Payment Successful!</h2>
        ...
        {status === 'FAILED' ? (
          <div className="mt-8">
            ...
            <p className="text-xl font-semibold mb-2 text-white">Generation Failed</p>
            <p className="text-zinc-400">Something went wrong while generating your report. Our team has been notified and will resolve this manually.</p>
            <button onClick={() => navigate('/dashboard')} className="mt-6 bg-zinc-800 hover:bg-zinc-700 text-white px-6 py-2 rounded-lg font-medium transition-colors">
              Go to Dashboard
            </button>
          </div>
        ) : (
